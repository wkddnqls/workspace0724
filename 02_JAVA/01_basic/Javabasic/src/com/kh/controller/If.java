...
public class If {
    /*
     * 기본적으로 프로그램의 진행은 순차저으로 이루어진다.
     * 
     * 특정 코드를 선택적으로 실행시키고 싶을 때 -> 조건문
     * 특정 코드르 반복해서 실행시키고 싶을 때 -> 반복문
     * 
     * *조건문
     * "조건식"을 통행 true 또는 false를 판단하고 then일 경우 그에 해당하는 코드를 실행.
     * 
     *
     */
 ...
 */
	...
	* 블록안의 코드를 실행할 수 있고 모든 조건이 연동되어 잇음
	*
	*
	*/
	/*
