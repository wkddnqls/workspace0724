...
public class Variable {
	 ...
	 * 자바는 2바이트 유니코드를 사용함.
	 */
	char ch1 = '최'; // 2바이트(16비트) 의 유니코드 정수로 저장됨
	char ch2 = '지';
	char ch3 = '원';
      
     System.out.println(""+ ch1 + ch2 + ch3); // + 때문에 숫자로나옴
     //"" 로 인해서 문자로 나옴   // 기본적으로 char은 연산시 int로 형변환이 일어난다.
	 ...
	 str2 = "누구?";
	 str2 = " ssagsadgas";
	 str2 = null; // String 의 변수는 참조변수이기 떄문에 기본값이 null이고 빈값을 표현하기위해선 null을쓴다
	...
	// \\ : 백슬래시
   // 문자 자체로 출력 \\ - 2개를 써야 문자로취급되며 1개가 출력됨
	 System.out.println("경로 : C:\\workspace");
   ...
   */
	...
	// MY_AGE = 124; -- 값을 초기화하면 2번 넣지 못한다
	  ...
	  * 프로그래밍에서 이름 짓는 방식
	  * 
	  * 카멜케이스 : 단어를 나열하며 이름을 짓되, 두번째단어부터는 단어의 첫글자를 대문자로 시작
	  ...
	  * ex) user_nave , total_price
	  * 
	  * 대문자스네이크케이스 : 스네이크케이스 + 모두 대문자 (대부분 언어에서 상수명)
	  *  ex) USER_NAME
	  * 
	  * 케밥케이스 : 단어를 소문자로 작성하되 문자와 문자사이를 하이픈(-)으로 이어주는 것
	  * (html 속성 , url , 설정파일등) 
	  * ex) user-name 
	  * 
	  * 
