...
public class DateAPI {
  public void method() {
	  Date date1 = new Date(); //매개변수없느 ㄴ생성자 호출시 코드실행시점의 컴퓨터 시간반영
	  System.out.println(date1.toString());
	  
	  //내가 원하는 날짜 (2026년 3월 3일)
	  //1)생성자를 통해서 생성
	  ...
	  System.out.println(1900 + date1.getYear() + "냔");
	  ...
	  System.out.println("현시시간 " + now);
  
     // 2. 특정 날짜와 시간 생성
	  LocalDateTime date3 = LocalDateTime.of(2026,3,3,0,0,0);
	  System.out.println("특정날짜와 시간 :  " + date3);
  
      //3. 날짜/시간 연산
	  System.out.println(date3.plusDays(10)); //date3에서 10일뒤
