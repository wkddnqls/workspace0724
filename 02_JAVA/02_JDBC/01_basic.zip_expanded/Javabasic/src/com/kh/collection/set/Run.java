...
/*
 * Set
 * 순서가없고, 중복을 허용하지 않는 자료구조
 * index개념이 없어서 위치기반 접근(get(index))불가
 ...
 */
	public static void main(String[] args) {
	 ...
	 //set에 저장해서 사용하는 객체(휴먼)은 equlas와 hashCode를 오버라이딩해줘야함.
	 ...
	 set.add(new Human("최지투", 20));
		...
		//Object의 hashCode ->주소값을 가지고 10진수형대의 해시값을 구한것
		
		//contanins() 요소에 포함여부 확인
		...
		// set 은 index명이 없기 때문에 get()을 사요할 수 없음
