 ...
 * 객체 생성시 부모 부분 -> 자식부분 순으로 메모리에 구성되며 , 
 * 자식객체 내부에 부모객체가 존재하는 것 처럼 실행된다
 * 
 * 장점
 * 재사용성/생산성 : 코드를 재사용하여 새로운 클래스를 정의할 수 있음
 * 유지보수서 : 공통코드를 사위에 두어 변경이 용이
 ...
 * - toString() , equals() , hashCode()등 오버라이딩가능
 * 
 */
	...
	/*
     ...
     m2.tellYourName();
     */
      // BusinessMan m3 = new Man(); 자식의 참조변수에 부모객체생성 x 
    
	Desktop d1 = new Desktop();
	Desktop d2 = new Desktop("d-100",200000,"LG",false);
		 TV t1 = new TV();
