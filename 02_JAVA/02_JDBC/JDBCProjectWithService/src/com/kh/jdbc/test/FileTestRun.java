...
public class FileTestRun {
	...
	public static void main(String[] args) {
		...
		// DB연결정보 , 프로그램 설정정보(port, 환경변수,,,), sql쿼리문등을 코드와 분리해서 관리할 때 주로사용
		// 파일로 출력 
	...
	try {
		...
		//prop.storeToXML() . xml파일로 객체의 정보를 저장
		//.xml 파일 -> xml형식 문서(태그구조)
		// -> dtd :xml 문서의 구조와 규칙을 정의한 문서
		prop.storeToXML(new FileOutputStream("resource/query.xml"),null);
		...
		*/
		...
		try {
			...
			System.out.println(propXml.getProperty("keywordselect"));
