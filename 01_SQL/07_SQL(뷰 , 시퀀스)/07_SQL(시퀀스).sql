...
/*
   ...
   [MINVALUE 최솟값 ] --> 최소값 지정 (기본값1 )
   [CYCLE | NOCYCLE ] --> 순환여부(NOCYCLE)
   [CYCHE | NOCACHE ] --> 캐시메모리 사용 여부
...
/*
      2 시퀀스 사용
      시퀀스명.NEXTVAL : 다음 숫자 발생 (INCREMENT 만큼증가)
      시퀀스명.CURRVAL : 가장 최근 생선된 값
...
/*
   ...
   [MINVALUE 최솟값 ] --> 최소값 지정 (기본값1 )
   [CYCLE | NOCYCLE ] --> 순환여부(NOCYCLE)
   [CYCHE 바이트 수 | NOCACHE ] --> 캐시메모리 사용 여부
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME , EMP_NO , JOB_CODE) VALUES
(SEQ_EMPNO.NEXTVAL, '최지구', '701011-1234567' ,'J7');
)

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME , EMP_NO , JOB_CODE) VALUES
(SEQ_EMPNO.NEXTVAL, '최지열', '701011-1234567' ,'J6');
)
