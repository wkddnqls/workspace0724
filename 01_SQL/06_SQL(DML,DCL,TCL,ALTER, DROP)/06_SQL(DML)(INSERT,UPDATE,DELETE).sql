/*
      ...
      DBL (DEFINITION 데티어 정의어) : DREATE, ALTER, DROP
...
( 900 , '김수민', '880914-1234567' , 'SD123@NAVER.COM' , 01038736521 , 'D7' ,
'J3' , 4000000, 0.2 , 204 ,'99/01/04' , NULL , 'N');

/*
 2)INSERT INTO 테이블명 (컬럼,컬럼,,,,,) VALUES(값,값,,,)
 테이블에 내가 선택한 컬럼에 대한 값만 INSERT할 수 있다.
 컬럼값을 제시하지않은 값은 기본적으로 NULL이 들어가며 DEFAULT가 설정되어 있다면
 DEFAULT값으로 설정됨.
 -> DEFAULT가 없고 NOT NULL제약조건이 걸려있는 컬럼은 반드시 직접 넣어줘야한다.
