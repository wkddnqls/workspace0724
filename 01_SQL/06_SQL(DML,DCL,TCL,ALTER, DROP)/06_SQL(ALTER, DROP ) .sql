/*
 ...
 <ALTER>
 객체를 변경하는 구문
 기존에 생성된 객체 (테이블 , 컬럼 , 제약조건 등)의 구조를 변경(수정,추가,제거,이름변경)
...
ALTER TABLE DEPARTMENT MODIFY LNAME NUMBER; --형식오류발생
...
--1_3) 컬럼 삭제 (DROP DOLUMN) : DROP COLUMN 삭제하고자하는 컬럼
...
-- DROP TABLE 테이블 CASCADE CONSTRANINT 
