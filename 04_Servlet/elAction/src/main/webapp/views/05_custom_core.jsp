...
<h3>4. 반복문 - forEach</h3>
<p>
  - 카운터 반복(for loop) : (c:forEach var="변수명" begin="초기값" end="끝값" [step="반복시 증가값"]) <br>
...
list.add(new Person("최지투",20 ,"여자"));
list.add(new Person("최지삼",22 ,"남자"));
