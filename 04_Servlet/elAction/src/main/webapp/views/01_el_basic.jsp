...
--%>
  ...
  <h2>2. EL문법을 이용해서 보다 쉽게 scope 값을 출력할 수 있음</h2>
  
 <p>
    EL을 이용하여 getter를 통해 가져올 필요없이 EL 구문내의 키만을 제시하면
    바로 접근가능 <br>
    EL은 JSP 의 scope 를 구분하지않고 자동으로 모든 scope의 키를 검색하여 존재하는 경우 그값을 가져옴
 </p>
