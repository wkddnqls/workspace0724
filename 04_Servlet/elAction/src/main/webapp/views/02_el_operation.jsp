...
<h3>2. 대소 비교</h3>
 ...
 personOne 이 null인가? ${personOne==null} 또는 ${personOne eq null} ${empty personOne} <br>
 personTwo 이 null인가? ${personTwo==null} 또는 ${personTwo eq null}  ${empty personTwo} <br>
 
 personTwo 이 null 아닌가? ${personTwo!=null} 또는 ${personTwo ne null}  ${not empty personTwo} <br>

arrOne은 비어있는가? ${ empty arrOne} <br>
arrTwo은 비어잇는가? ${ empty arrTwo} <br>

<h4>4. 논리 연산자</h4>
ture && true : ${true && true } 또는 ${true and true }<br>
false || flase : ${true || flase } 또는 ${ false or flase }<br>

big이 small보다 크도 arrOne은 비어잇는가?
