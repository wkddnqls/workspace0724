...
<body>
    ...
    <p>
        ...
        EL구문을 사용하면 표현하고자하는 값을 ${name}의 형식으로 출력할 수 있다 <br> 
    ...
    <%--
       ...
       3. 액션태그(Action Tag)
          ...
          >> 커스텀애션태그 : 별로 라이브버리로 등록하여 사용하는 태그(JSTL등...)
    ...
    2) jakarta.servlet.jsp.jstl-api jakarta.servlet.jsp.jstl 다운로드
