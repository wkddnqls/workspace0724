...
function test4(){
   var num2 = 11;
   console.log("num1 in stest4 :" + num1 );
 ...
 *  자신이 선언된 위치에서의 전역 스코프변수를 가져옴. -> 렉시컬 스코프
 *  
 *   렉시컬스코프 != 동적스코프
...
//var는 함수 스코프이기때문에 for문내에 새로운 i가 생기지않고 전역에 i를 저장함
// for문이 종료되어도 i는 그대로 유지

//let.const 는 블록 스코프이기떄문에 for문내에 새로운 스코프를 만들고 j를 해당
// 스코프에 저장해 사용한뒤 for문이 종료되면 별개로 전역에잇는 j는 그대로 전역변수로 사용됨.
