...
// js는 오버로딩을 지원하지않는다 . 매개변수의 갯수가 달라도 동일한 매서드로 인식한다.

let test4 = function(name)
{
    //js함수는 기본적으로 arguments객체를 가지고잇음 -> 전달받은 모든 인자값이 들어있는 배열
